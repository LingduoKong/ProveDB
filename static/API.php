    ...
    <div class="container" style="padding-top:70px">
        <div id="API" class="jumbotron" style="height:1000px;">
            ...
            <div class="col-md-4">
                ...
                <img src="img/Upload.png" style="width:50px;height:50p" id="post" value="post_client">
                <hr>
<!--                     <p>
                        <small>
                ...
                <div class="col-md-4">
                    ...
                    <img src="img/Download.png" style="width:50px;height:50p" id="q2" value="q2_client">
                    <hr>
<!--                     <p>
                        <small>
